...
public class GameUI {
    ...
    public void highlightValidMoves(String payload) { 
        ...
        for (String move : payload.split(";")) { 
            ...
            boardButtons[r][c].setBackground(HIGHLIGHT_VALID_MOVE); 
    ...
    public void highlightSelectedBoardPiece(int r, int c) { boardButtons[r][c].setBorder(new LineBorder(HIGHLIGHT_SELECTED_PIECE, 2)); }
    ...
    public void clearHighlights(boolean clearSelection) {
        ...
        for (int[] cell : initialHighlightCells) boardButtons[cell[0]][cell[1]].setBackground(UIManager.getColor("Button.background"));
