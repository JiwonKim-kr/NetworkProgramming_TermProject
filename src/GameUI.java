...
public class GameUI {
    ...
    public String promptForNewNickname() {
        return JOptionPane.showInputDialog(frame, "새로운 닉네임을 입력하세요:", "닉네임 변경", JOptionPane.PLAIN_MESSAGE);
    }
    ...
    private void updateCapturedPieces(String p1CapturedStr, String p2CapturedStr) {
        ...
        String myPlayerRole = controller.getPlayerRole();
        String myCapturedStr = "P1".equals(myPlayerRole) ? p1CapturedStr : p2CapturedStr;
        String opponentCapturedStr = "P1".equals(myPlayerRole) ? p2CapturedStr : p1CapturedStr;
